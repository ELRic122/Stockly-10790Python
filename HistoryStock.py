...
class HistoricoStock(QMainWindow): 
    def __init__(self, viewsuppliersClass_ref): # Construtor da classe
        ...
        self.tabela.setHorizontalHeaderLabels(["ID STOCK","NOME", "VALOR ANTIGO", "VALOR NOVO", "DATA ALTERAÇÃO"])
    ...
    def carregarHistorico(self):
        ...
        try:
            cursor.execute("""
                SELECT id_Stock, campo_alterado, valor_antigo, valor_novo, data_alteracao
