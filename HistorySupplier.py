...
# Classe do histórico de Fornecedores
class HistoricoFornecedores(QMainWindow): 
    def __init__(self, viewsuppliersClass_ref): # Construtor da classe
        ...
        self.setWindowTitle('Stockly - Histórico de Alterações dos Fornecedores')
        ...
        titulo = QLabel("Últimas Alterações aos Fornecedores")
        ...
        self.tabela.setHorizontalHeaderLabels(["ID Fornecedor","CAMPO ALTERADO", "VALOR ANTIGO", "VALOR NOVO", "DATA ALTERAÇÃO"])
    ...
    def carregarHistorico(self):
        ...
        try:
            cursor.execute("""
                SELECT id_Fornecedor, campo_alterado, valor_antigo, valor_novo, data_alteracao
                FROM historico_Fornecedor
    ...
    # Função para voltar tabela dos Fornecedores
