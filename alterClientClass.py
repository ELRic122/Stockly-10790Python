...
class AlterarCliente(QMainWindow):
    def __init__(self, alterMenuClass_ref):
        ...
        self.btnVoltar.setFixedSize(60, 60)
        self.btnVoltar.setStyleSheet("font-size: 30px; font-weight: bold; background: transparent; border: none;")
        self.btnVoltar.clicked.connect(self.voltar)
        topBarLayout.addWidget(self.btnVoltar)
        ...
        # Campos de edição (melhor visual)
