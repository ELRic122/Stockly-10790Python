...
# Classe do histórico de Vendas
class HistoricoVendas(QMainWindow): 
    def __init__(self, viewsalesClass_ref): # Construtor da classe
        super().__init__() # Inicializa a classe pai
        self.ViewSales = viewsalesClass_ref # Referência ao menu de visualizar registos
        self.setWindowTitle('Stockly - Histórico de Alterações das Vendas')
        ...
        titulo = QLabel("Últimas Alterações aos Produtos")
        ...
        self.tabela.setHorizontalHeaderLabels(["ID VENDA","NOME", "VALOR ANTIGO", "VALOR NOVO", "DATA ALTERAÇÃO"])
    ...
    def carregarHistorico(self):
        ...
        try:
            cursor.execute("""
                SELECT id_Venda, campo_alterado, valor_antigo, valor_novo, data_alteracao
    ...
    # Função para voltar tabela das Vendas
